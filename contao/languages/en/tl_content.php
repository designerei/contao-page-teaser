...
$GLOBALS['TL_LANG']['tl_content']['teaserPage'] = ['Page', 'Please choose one page.'];
$GLOBALS['TL_LANG']['tl_content']['teaserPages'] = ['Pages', 'Please choose one or more pages.'];
$GLOBALS['TL_LANG']['tl_content']['pages'] = ['Pages', 'Please choose one or more pages.'];
$GLOBALS['TL_LANG']['tl_content']['title_asc'] = 'Page title (ascending)';
$GLOBALS['TL_LANG']['tl_content']['title_desc'] = 'Page title (descending)';
